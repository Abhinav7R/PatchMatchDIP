...
This is an application of the PatchMatch algorithm for image inpainting.
This uses the EM algorithm to fill in the masked regions of an image with the help of NNFs.
"""
